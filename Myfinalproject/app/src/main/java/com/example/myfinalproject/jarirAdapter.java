...
public class jarirAdapter extends RecyclerView.Adapter {
    ...
    public jarirAdapter(ArrayList<Items> item, jarirActivity jarirActivity) {
        this.arry=item;
        this.context=jarirActivity;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        jarirAdapter.ViewHolder vh = new jarirAdapter.ViewHolder(view);
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(arry.get(position).getImage()).into(((jarirAdapter.ViewHolder) holder).photo);

        ((jarirAdapter.ViewHolder) holder).title.setText(arry.get(position).getName());
        ((ViewHolder) holder).genre.setText(arry.get(position).getGenre());
        ((ViewHolder) holder).price.setText(arry.get(position).getPrice()+"kd");

        ((jarirAdapter.ViewHolder) holder).view.setOnClickListener(new View.OnClickListener() {
            @Override
