...
public class sofiaAdapter extends RecyclerView.Adapter {
    ...
    public sofiaAdapter(ArrayList<Items> item, sofiaActivity sofiaActivity) {
        this.arry=item;
        this.context=sofiaActivity;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        sofiaAdapter.ViewHolder vh = new sofiaAdapter.ViewHolder(view);
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(arry.get(position).getImage()).into(((sofiaAdapter.ViewHolder) holder).photo);

        ((sofiaAdapter.ViewHolder) holder).title.setText(arry.get(position).getName());
        ((sofiaAdapter.ViewHolder) holder).genre.setText(arry.get(position).getGenre());
        ((sofiaAdapter.ViewHolder) holder).price.setText(arry.get(position).getPrice()+"kd");

        ((sofiaAdapter.ViewHolder) holder).view.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((sofiaAdapter.ViewHolder) holder).add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
